...
def extract_clinical_facts(clinical_note: str) -> ClinicalExtraction:
    """
    Extract structured clinical facts from a free-text note.
    Tries LLM first, falls back to heuristic extractor.
